...
Targets two vehicles: **CORRIS** (the car — wear reduction on selected engine and body components) and **MACHTWAGEN** (the taxi drivetrain — Automated Manual Transmission).
